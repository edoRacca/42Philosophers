...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/24 10:52:09 by eraccane          #+#    #+#             */
/*   Updated: 2023/09/24 11:22:00 by eraccane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_philos(t_philo *philos, t_general *program, pthread_mutex_t *forks,
		char *av[])
{
	int	i;
